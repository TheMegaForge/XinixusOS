...
SETUP void unfoldVirtual(uint64_t virtual,uint16_t* pml4,uint16_t* pdpt,uint16_t* pdt,uint16_t* pt,uint16_t* offset){
    *pml4   = (virtual & 0b0000000000000000111111111000000000000000000000000000000000000000 ) >> 39;
    *pdpt   = (virtual & 0b0000000000000000000000000111111111000000000000000000000000000000 ) >> 30;
    *pdt    = (virtual & 0b0000000000000000000000000000000000111111111000000000000000000000 ) >> 21;
    *pt     = (virtual & 0b0000000000000000000000000000000000000000000111111111000000000000 ) >> 12;
